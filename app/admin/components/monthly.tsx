...
export function Monthly({ docs, global, loading }: MonthlyProps) {
  ...
  const defaultChart: ChartDataPoint[] = sorted
    ...
    .map(d=>({ label:formatMonthLabel(d.id), usersSignedUp:d.usersSignedUp, totalEscrow:d.totalEscrow, totalWithdrawn:d.totalWithdrawn, productsCreated:d.productsCreated }))
  ...
  const renderContent = () => {
    ...
    const customChart: ChartDataPoint[] = sortedCustom.map(d=>({ label:formatMonthLabel(d.id), usersSignedUp:d.usersSignedUp, totalEscrow:d.totalEscrow, totalWithdrawn:d.totalWithdrawn, productsCreated:d.productsCreated }))
