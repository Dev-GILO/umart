...
export function Yearly({ docs, global, loading }: YearlyProps) {
  ...
  const defaultChart: ChartDataPoint[] = sorted
    ...
    .map(d=>({ label:String(d.id), usersSignedUp:d.usersSignedUp, totalEscrow:d.totalEscrow, totalWithdrawn:d.totalWithdrawn, productsCreated:d.productsCreated }))
  ...
  const renderContent = () => {
    ...
    const customChart: ChartDataPoint[] = sortedCustom.map(d=>({ label:String(d.id), usersSignedUp:d.usersSignedUp, totalEscrow:d.totalEscrow, totalWithdrawn:d.totalWithdrawn, productsCreated:d.productsCreated }))
